...
const SHADERS_JSON_GITHUB_PATH="/moostafa-afk/godot-sprite-shader-mixer/v1/shaders/shaders.json"
const SHADERS_GITHUB_DOMAIN="raw.githubusercontent.com"
const SHADERS_GITHUB_BASE_PATH="/moostafa-afk/godot-sprite-shader-mixer/v1/shaders/"
